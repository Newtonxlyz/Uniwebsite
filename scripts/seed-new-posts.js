...
const posts = [
  {
    ...
    excerpt: '昨晚重温《艺妓回忆录》，小百合望向会长的眼神让我心头一颤。那种"一生只为你一人起舞"的执念，明知身份悬殊，却仍交出全部真心。',
    content: `昨晚重温《艺妓回忆录》🌙
小百合望向会长的眼神，让我心头一颤。
...
*诗歌 · 2026年3月24日 · 雷迪嘎嘎小红书*`,
  ...
  },
  {
    ...
    excerpt: '有些再见，再也不见。很喜欢的词，不能多读。十年生死两茫茫，不思量，自难忘。千里孤坟，无处话凄凉。',
    content: `有些再见，再也不见。
很喜欢的词，不能多读。
...
async function main() {
  ...
  for (const p of posts) {
    ...
    console.log(`✓ Created: ${created.slug} - ${created.title}`);
  }
