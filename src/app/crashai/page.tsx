...
export default async function CrashAIDashboard() {
  ...
  const phases = [
    ...
    { name: "Phase D", title: "安全领域专项", desc: "汽车安全 AI · 4 大训练路径", lessons: lessons.filter((l: any) => l.phase === "D") },
  ];
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 flex flex-wrap gap-4">
          ...
          <Link
            ...
            style={{ background: "linear-gradient(135deg, rgba(167,139,250,0.25) 0%, rgba(245,158,11,0.15) 100%)", borderColor: "rgba(167,139,250,0.4)" }}
          >
            🧠 安全领域训练 4 大路径 →
          </Link>
